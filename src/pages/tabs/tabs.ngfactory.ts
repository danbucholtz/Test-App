...
class _View_TabsPage0 extends import1.AppView<import3.TabsPage> {
  ...
  createInternal(rootSelector:string):import2.AppElement {
    ...
    this.renderer.setElementAttribute(this._el_2,'tabIcon','create');
    this.renderer.setElementAttribute(this._el_2,'tabTitle','Posts');
    ...
    this.renderer.setElementAttribute(this._el_4,'tabTitle','Categories');
    ...
    this.renderer.setElementAttribute(this._el_6,'tabIcon','document');
    this.renderer.setElementAttribute(this._el_6,'tabTitle','Pages');
    ...
    this.renderer.setElementAttribute(this._el_8,'tabIcon','bookmark');
    this.renderer.setElementAttribute(this._el_8,'tabTitle','Favorites');
